    ...
    <form:form action="addTest" method="POST" commandName="test">
      ...
      <div class="form-group">
        <label for="exerciceName">Test Name :</label>
      	<form:input type="text" path="name" class="form-control" id="exerciceName"/>
      </div>
      <div class="container" ng-repeat="index in ctr.exe">
        <div class="container">
          <div class="form-group">
            <label for="question{{index}}">Qustion {{index}}:</label>
            <form:input path="question" type="text"  class="form-control" id="question{{index}}"/>
          </div>
          <div class="form-group">
            <label for="answer{{index}}">Answer {{index}}:</label>
            <form:input type="text" path="answer" class="form-control" id="answer{{index}}"/>
          </div>
        </div>
